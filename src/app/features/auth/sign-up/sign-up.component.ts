  ...
  template: `
    <form [formGroup]="signUpForm" (ngSubmit)="onSubmit()" class="sign-up-form">
      ...
      <mat-form-field appearance="outline">
        ...
        <input matInput type="password" formControlName="password2" placeholder="Re-enter your password">
        <mat-error *ngIf="signUpForm.get('password2')?.errors?.['required']">Password confirmation is required</mat-error>
